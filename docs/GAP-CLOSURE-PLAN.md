...
| OPS-001 | Health/readiness and Railway checks | VERIFY | Public, uncached liveness and database-readiness routes use a two-second single-flight probe and generic 503 failure. Railway configuration targets `/api/ready` while preserving the mandatory migration gate. Focused suite: 5 files / 27 tests; full local suite: 436 files / 4,719 tests; real-Postgres suite: 4 files / 31 tests. Types, the 391-page build, and production-mode database outage/recovery smoke pass. CI and exact production rollout evidence remain. The separate seven-day Phase 0 observation is not complete. Evidence: [`docs/operations/ops-001-readiness-2026-09-23.md`](./operations/ops-001-readiness-2026-09-23.md) |
