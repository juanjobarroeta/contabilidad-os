...
export const PREGUNTAS_EVAL: PreguntaEval[] = [
  ...
  // ── Periferia de nómina, mercantil, antilavado y estatal (fuentes nuevas):
  // miden que la KB ampliada devuelva la ley correcta sin diluir las demás.
  { id: "n01", tema: "nomina", pregunta: "¿Cada cuándo debo revisar la prima de riesgo de trabajo de mi empresa ante el IMSS y en qué mes se presenta?", fundamentos: ["Art. 32 RACERF", "Art. 74 LSS"], nota: "RACERF Art. 32: revisión anual de siniestralidad; declaración en febrero." },
  { id: "n02", tema: "nomina", pregunta: "¿Qué obligaciones tiene el patrón para retener y enterar al INFONAVIT el descuento del crédito de vivienda de un trabajador?", fundamentos: ["Art. 29 LINFONAVIT", "Art. 42 RIPAEDI", "Art. 43 RIPAEDI"], nota: "RIPAEDI capítulo de descuentos; Art. 29 LINFONAVIT obligaciones patronales. Números del RIPAEDI por confirmar tras la ingesta." },
  { id: "n03", tema: "contabilidad", pregunta: "¿Cuántos años estoy obligado a conservar los libros y comprobantes de mi negocio según el Código de Comercio?", fundamentos: ["Art. 46 CCOM", "Art. 49 CCOM", "Art. 30 CFF"], valoresEsperados: [10], nota: "CCom Art. 46: diez años." },
  { id: "n04", tema: "sociedades", pregunta: "¿Puede una S.A. de C.V. repartir dividendos si la asamblea aún no aprueba los estados financieros del ejercicio?", fundamentos: ["Art. 19 LGSM", "Art. 181 LGSM"], nota: "LGSM Art. 19: sólo tras la aprobación de los estados financieros; Art. 181 asamblea ordinaria en los 4 meses siguientes." },
  { id: "n05", tema: "antilavado", pregunta: "Vendo autos usados; ¿desde qué monto es actividad vulnerable y cuándo presento el aviso a la UIF?", fundamentos: ["Art. 17 LFPIORPI", "Art. 23 LFPIORPI"], nota: "Art. 17 fracción sobre vehículos (umbral en UMA); aviso a más tardar el día 17 del mes siguiente (Art. 23)." },
  { id: "n06", tema: "estatal", pregunta: "Tengo empleados en Puebla, ¿qué impuesto estatal causo por su nómina, en qué ley está y a qué tasa?", fundamentos: ["Art. 11 LHPUE", "Art. 13 LHPUE", "Art. 14 LHPUE", "Art. 15 LHPUE"], valoresEsperados: [3], nota: "Impuesto sobre erogaciones por remuneraciones al trabajo personal, LHPUE Arts. 11–21; tasa 3 % (catálogo isn.tasa PUE)." },
  { id: "n07", tema: "estatal", pregunta: "¿Cuál es la tasa del impuesto sobre nóminas en la Ciudad de México y en qué artículo está?", fundamentos: ["Art. 158 CFCDMX", "Art. 156 CFCDMX"], valoresEsperados: [4], nota: "CFCDMX Art. 158; 4 % en el catálogo 2026 (el PDF de 2021 dice 3 %: la KB debe traer el texto vigente de la Consejería)." },
  { id: "n08", tema: "derechos", pregunta: "El SAT inició una visita domiciliaria en mi negocio, ¿qué derechos tengo desde el primer día?", fundamentos: ["Art. 2 LFDC", "Art. 12 LFDC", "Art. 44 CFF"], nota: "LFDC Art. 2 (derechos generales) y 12 (ser informado al inicio de facultades de comprobación)." },
];
