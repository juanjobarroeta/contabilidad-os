...
export const FUENTES: FuenteFiscal[] = [
  ...
  },
  {
    ...
    metodo: "manual",
    estado: "activo",
    refresco: "PR a catalog.ts (clave uma.valor); cerrar vigencia anterior y agregar la nueva (1-feb).",
    autoridad: "INEGI",
  ...
  // ── Factores externos (consumidos por cálculos; pendientes de cablear) ───────
  {
    ...
    metodo: "semiauto",
    estado: "activo",
    refresco: "PR a src/lib/fiscal/inpc.ts con el INPC del mes (~día 10); el cron inpc-refresh.yml avisa si se atrasa.",
    autoridad: "INEGI (DOF)",
