...
/**
 * Lanza AuthzError(403) si el rol de construcción no permite (método, ruta).
 * Sólo aplica a /api/construccion/*; cualquier otra ruta pasa intacta
 * (p. ej. /api/auth/* para cambiar contraseña).
 */
