...
const REGLAS: [RegExp, Materia[]][] = [
  ...
  [/C[ÓO]DIGO Civil|Procedimientos Civiles|Procesal Civil|Responsabilidad Civil|Expropiaci[óo]n|Mecanismos Alternativos de Soluci[óo]n de Controversias$|Notariado|Notarial|Registro P[úu]blico de la Propiedad|Catastro/i, ["civil"]],
  [/Civiles y Familiares|C[ÓO]DIGO Civil Federal|C[ÓO]DIGO (?:de )?Familia|Familiar(?:es)?\b|Procedimientos Familiares|Procesal Familiar|Alimentos|Adopci[óo]n|Violencia Familiar/i, ["familiar"]],
  [/Justicia Alternativa|Justicia Administrativa|Contencioso Administrativo|Procedimiento Contencioso|Tribunal de Justicia Administrativa|Juicio Oral|Justicia para Adolescentes|Justicia C[íi]vica|Mediaci[óo]n|Conciliaci[óo]n|Medios Alternos|Justicia Restaurativa/i, ["procesal"]],
  [/\bFamilia\b/i, ["familiar"]],
  [/\bHacienda\b|C[ÓO]DIGO Financiero/i, ["fiscal", "hacienda_publica"]],
  ...
  [/Poder Judicial|Carrera Judicial|Tribunales Agrarios|Fiscal[íi]a General|Defensor[íi]a P[úu]blica|Tribunal Federal|Tribunal Superior|Procuradur[íi]a|Justicia Alternativa|Justicia Administrativa/i, ["judicial"]],
  [/C[ÓO]DIGO Fiscal|Ley de Hacienda|Ley de Ingresos|Impuesto|Contribuci[óo]n|Catastral/i, ["fiscal"]],
