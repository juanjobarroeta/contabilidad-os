...
// El parser puro vive en recibo-parser.ts (sin Prisma, apto para el cliente);
// se re-exporta para que los llamadores existentes no cambien.
export {
  parseReciboNominaHistorico,
  derivarTipoCorrida,
  type DesgloseNomina,
  type ReciboNominaHistorico,
  type TipoCorrida,
} from "./recibo-parser";
import { derivarTipoCorrida, parseReciboNominaHistorico, type ReciboNominaHistorico, type TipoCorrida } from "./recibo-parser";
