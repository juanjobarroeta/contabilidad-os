      ...
      <div className="flex flex-wrap items-end justify-between gap-3">
        <div>
          <nav className="mb-2 inline-flex rounded-control border border-cos-line p-0.5 text-[12.5px] font-medium">
            <Link href="/clientes" className="rounded-[8px] px-2.5 py-1 text-cos-ink-soft hover:text-cos-ink">Clientes</Link>
            <Link href="/proveedores" className="rounded-[8px] bg-cos-slate-tint px-2.5 py-1 text-cos-ink">Proveedores</Link>
