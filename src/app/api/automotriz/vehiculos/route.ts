  ...
  const [vehiculos, sumas, interes] = await Promise.all([
    prisma.vehiculo.findMany({
      ...
      select: {
        ...
        precioVenta: true, precioLista: true, fechaVenta: true, ventaInvoiceId: true, autoCreado: true,
        mercado: { select: { precioMediana: true, precioMin: true, precioMax: true, consultadoAt: true } },
