...
const SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      // El expediente dejó la sidebar: como página suelta no se entendía para
      // qué era. Vive donde se usa (ExpedienteEnContexto en Bancos, Directorio
      // y Mi Empresa); /expediente sigue, enlazada desde el rail del copiloto.
    ],
  },
  {
    label: "Fiscal",
    ...
    <>
      ...
      <nav className="flex-1 px-3 py-3 overflow-y-auto">
        ...
        <div className="space-y-1">
          ...
          {/* «Pendientes» se retiró del menú (decisión del owner, revisión
              página por página): el trabajo pendiente vive en Inicio (pasos,
              cola) y en el rail del Copiloto. El historial de avisos del
              sistema quedó en /avisos, enlazado desde Configuración →
              Notificaciones. */}
          {showCartera && (
